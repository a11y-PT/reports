...
| label:"chk 10 web" | label:"R 5.3" | R 5.3 - 10 Aspetos Web (Imagens-link, propósito equivalente em texto) | corrigido | [#32](https://github.com/a11y-PT/report_061/issues/32) |
...
| label:"chk transação" | label:"R 3.2" | R 3.2 - Transação (Resposta) | corrigido | [#6](https://github.com/a11y-PT/report_061/issues/6) |
| label:"chk transação" | label:"R 4.3" | R 4.3 - Transação (Erros) | corrigido | [#67](https://github.com/a11y-PT/report_061/issues/67) |
| label:"chk transação" | label:"R 4.3" | R 4.3 - Transação (Erros) | corrigido | [#70](https://github.com/a11y-PT/report_061/issues/70) |
