...
| label:"chk conteúdo" | label:"R 3.3" | R 3.3 - Conteúdo - Falta de identificação complementar nas hiperligações | NOK | [#60](https://github.com/a11y-PT/report_064/issues/60) |
...
| label:"chk transação" | label:"R 2.4" | R 2.4 - Transação - Não há informação clara sobre o que é o asterisco nos campos de preenchimento obrigatório | NOK | [#65](https://github.com/a11y-PT/report_064/issues/65) |
...
| label:"chk transação" | label:"R 3.2" | R 3.2 - Transação - Feedback após submissão não acessível | melhoria | [#4](https://github.com/a11y-PT/report_064/issues/4) |
