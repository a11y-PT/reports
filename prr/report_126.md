...
|:--|:--|:--|:--|:--|
| label:"chk 10 web" | label:"R 4.1" | R 4.1 - 10 Aspetos - O switch não possui etiqueta associada ao campo | melhoria | [#9](https://github.com/a11y-PT/report_126/issues/9) |
| label:"chk 10 web" | label:"R 4.1" | R 4.1 - 10 Aspetos - Existem formulários em PDF | corrigido | [#10](https://github.com/a11y-PT/report_126/issues/10) |
| label:"chk 10 web" | label:"R 4.1" | R 4.1 - 10 Aspetos - A etiqueta não está visível | corrigido | [#11](https://github.com/a11y-PT/report_126/issues/11) |
| label:"chk 10 web" | label:"R 4.1" | R 4.1 - 10 Aspetos - Os radiobuttons não estão agrupados por fieldset | melhoria | [#12](https://github.com/a11y-PT/report_126/issues/12) |
...
| label:"chk 10 web" | label:"R 5.3" | R 5.3 - 10 Aspetos - Imagem link têm um equivalente alternativo incorreto | corrigido | [#5](https://github.com/a11y-PT/report_126/issues/5) |
...
| label:"chk conteúdo" | label:"R 2.1" | R 2.1 - Conteúdo - O corpo de texto tem um tamanho inferior a 12pt (equivalente a 16px) | corrigido | [#18](https://github.com/a11y-PT/report_126/issues/18) |
| label:"chk conteúdo" | label:"R 3.3" | R 3.3 - Conteúdo - Falta de identificação complementar nas hiperligações | corrigido | [#6](https://github.com/a11y-PT/report_126/issues/6) |
...
| label:"chk transação" | label:"R 2.4" | R 2.4 - Transação - Não é possível identificar os campos obrigatórios em formulários PDF | melhoria | [#16](https://github.com/a11y-PT/report_126/issues/16) |
...
| label:"av auto" |  | Avaliação Automática - Accessmonitor/Observatório (em avaliação) | OK | [#2](https://github.com/a11y-PT/report_126/issues/2) |
| label:"testes usabilidade" |  | Testes de usabilidade - O relatório apresenta as informações necessárias | OK | [#19](https://github.com/a11y-PT/report_126/issues/19) |
