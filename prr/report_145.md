...
|:--|:--|:--|:--|:--|
| label:"chk 10 web" | label:"R 4.1" | R 4.1 - 10 Aspetos - Existem formulários em PDF | corrigido | [#10](https://github.com/a11y-PT/report_145/issues/10) |
...
| label:"chk conteúdo" | label:"R 5.2" | R 5.2 - Conteúdo - Elementos interativos com área clicável inferior à dimensão mínima recomendada de 44px CSS | corrigido | [#4](https://github.com/a11y-PT/report_145/issues/4) |
| label:"chk transação" | label:"R 2.4" | R 2.4 - Transação - Há campos obrigatórios que não estão identificados como tal | OK | [#19](https://github.com/a11y-PT/report_145/issues/19) |
| label:"chk transação" | label:"R 2.4" | R 2.4 - Transação - Não é possível identificar campos obrigatórios nos formulários em PDF e Word | melhoria | [#20](https://github.com/a11y-PT/report_145/issues/20) |
| label:"chk transação" | label:"R 3.2" | R 3.2 - Transação - Feedback anunciado com utilização de região ARIA inadequada | corrigido | [#3](https://github.com/a11y-PT/report_145/issues/3) |
| label:"chk transação" | label:"R 4.3" | R 4.3 - Transação - Mensagens de erro não associadas programaticamente aos respetivos campos | corrigido | [#7](https://github.com/a11y-PT/report_145/issues/7) |
| label:"av auto" |  | Avaliação Automática - Accessmonitor/Observatório (em avaliação) | OK | [#1](https://github.com/a11y-PT/report_145/issues/1) |
