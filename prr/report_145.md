...
| label:"chk transação" | label:"R 2.4" | R 2.4 - Transação - Há campos obrigatórios que não estão identificados como tal | melhoria | [#19](https://github.com/a11y-PT/report_145/issues/19) |
...
| label:"chk transação" | label:"R 3.2" | R 3.2 - Transação - Feedback anunciado com utilização de região ARIA inadequada | NOK | [#3](https://github.com/a11y-PT/report_145/issues/3) |
